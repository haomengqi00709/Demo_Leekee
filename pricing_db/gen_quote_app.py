...
@media (prefers-color-scheme:dark){:root{
  --bg:#131519;--surface:#1b1e23;--surface2:#22262d;--ink:#e6e8ec;--ink2:#98a0ab;--line:#2c313a;
  --accent:#d8964f;--accent2:#e6ac6c;--soft:rgba(216,150,79,.14);--good:#54ab82;--warn:#c99a44;}}
  ...
  <div class="grid">
    ...
    <section class="card" id="quote-card">
      ...
      <div class="actions noprint" id="actions" style="display:none">
        <button class="btn pri" onclick="window.print()">打印 / 导出 PDF</button>
